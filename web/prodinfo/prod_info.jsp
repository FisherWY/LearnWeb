...
<html>
<head>
	<link href="/LearnWeb/prodinfo/css/prodInfo.css" rel="stylesheet" type="text/css">
</head>
<body>
	...
	<div id="warp">
		<div id="left">
			<div id="left_top">
				<img src="/LearnWeb/getProdImg?imgurl=${prod.imgurl}"/>
			</div>
			<div id="left_bottom">
				<img id="lf_img" src="/LearnWeb/prodinfo/img/prodInfo/lf.jpg"/>
				<img id="mid_img" src="/LearnWeb/getProdImg?imgurl=${prod.imgurl}" width="60px" height="60px"/>
				<img id="rt_img" src="/LearnWeb/prodinfo/img/prodInfo/rt.jpg"/>
			</div>
		</div>
